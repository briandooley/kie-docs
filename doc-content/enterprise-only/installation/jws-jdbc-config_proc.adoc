...
Use XA datasources to ensure that distributed transactions maintain atomicity. Do not use non-XA datasources unless you are positive you do not have multiple resources participating in single transactions.
