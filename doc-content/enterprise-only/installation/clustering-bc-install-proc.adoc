...
.Procedure
. Add {EAP} management users to the master node of the cluster (where you configured the `domain.xml` file) as described in the https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/{EAP_VERSION}/html-single/configuration_guide/[_Red Hat JBoss EAP 7.4 Configuration Guide_].
...
----
+
For more information, see the following sections of the _Red Hat JBoss EAP 7.4 Configuration Guide_:
