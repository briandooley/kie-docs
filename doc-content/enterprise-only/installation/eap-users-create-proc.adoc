...
[NOTE]
====
It is recommended to use file-based users in {PRODUCT} rather than properties-based users. You can change to using file-based users by running the following command:
