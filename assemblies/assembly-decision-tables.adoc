...
[NOTE]
====
You can also design your decision service using Decision Model and Notation (DMN) models instead of rule-based or table-based assets. For information about DMN support in {PRODUCT} {PRODUCT_/Users/bdooley/Documents/code/kie-docs/assemblies/assembly-drl-rules.adocVERSION}, see the following resources:
