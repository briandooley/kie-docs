...
.Prerequisites
* The space and project for the guided rules have been created in {CENTRAL}. Each asset is associated with a project assigned to a space. For details, see {URL_GETTING_STARTED}#assembly-getting-started-decision-services[_{GETTING_STARTED_DECISION_SERVICE}_].
